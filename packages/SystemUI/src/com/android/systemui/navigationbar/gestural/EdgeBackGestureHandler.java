    ...
    private void triggerAction(boolean isVertical) {
        ...
        switch (action) {
            ...
            case 1: // Assistant
                ...
                break;
            case 2: // Voice search
                XtendedUtils.launchVoiceSearch(mContext);
                break;
            case 3: // Camera
                XtendedUtils.launchCamera(mContext);
                break;
            case 4: // Flashlight
            ...
            case 5: // Application
                ...
                break;
            case 6: // Volume panel
                XtendedUtils.toggleVolumePanel(mContext);
                break;
            case 7: // Screen off
            ...
            case 12: // Ringer modes
                XtendedUtils.toggleRingerModes(mContext);
                break;
            case 13: // Kill app
